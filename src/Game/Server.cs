...
namespace Game
{
	...
	public class Server : ServerBase
	{
		...
		internal void PendingUser(string userId, ulong key, byte permission, int accId)
		{
		...
		internal void OnUserJoin(Player player, string userId, ulong key)
		{
