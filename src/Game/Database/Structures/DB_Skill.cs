...
namespace Game.Database.Structures
{
	public class DB_Skill
	{
		...
		public char elemental { get; set; }
		public char is_passive { get; set; }
		public char is_physical_act { get; set; }
		public char is_harmful { get; set; }
		public char is_need_target { get; set; }
		public char is_corpse { get; set; }
		public char is_toggle { get; set; }
		public int toggle_group { get; set; }
		public char casting_type { get; set; }
		public char casting_level { get; set; }
		...
		public char vf_one_hand_sword { get; set; }
		public char vf_two_hand_sword { get; set; }
		public char vf_double_sword { get; set; }
		public char vf_dagger { get; set; }
		public char vf_double_dagger { get; set; }
		public char vf_spear { get; set; }
		public char vf_axe { get; set; }
		public char vf_one_hand_axe { get; set; }
		public char vf_double_axe { get; set; }
		public char vf_one_hand_mace { get; set; }
		public char vf_two_hand_mace { get; set; }
		public char vf_lightbow { get; set; }
		public char vf_heavybow { get; set; }
		public char vf_crossbow { get; set; }
		public char vf_one_hand_staff { get; set; }
		public char vf_two_hand_staff { get; set; }
		public char vf_shield_only { get; set; }
		public char vf_is_not_need_weapon { get; set; }
		...
		public char uf_self { get; set; }
		public char uf_party { get; set; }
		public char uf_guild { get; set; }
		public char uf_neutral { get; set; }
		public char uf_purple { get; set; }
		public char uf_enemy { get; set; }
		public char tf_avatar { get; set; }
		public char tf_summon { get; set; }
		public char tf_monster { get; set; }
		...
		public char state_type { get; set; }
